 ...
 * 
 */
class Chestnut_Layerednav_Block_Layer_Filter_Size extends Mage_Catalog_Block_Layer_Filter_Attribute 
{
    public function __construct() 
    {
        if ($this->helper('chestnut_layerednav')->getConfig('general/enable')) {
            parent::__construct();
            $this->setTemplate('chestnut/layerednav/layer_size.phtml');
