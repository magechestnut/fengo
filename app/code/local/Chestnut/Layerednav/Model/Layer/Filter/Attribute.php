 ...
 * 
 */
class Chestnut_Layerednav_Model_Layer_Filter_Attribute extends Mage_Catalog_Model_Layer_Filter_Attribute
{
    ...
    protected function _getItemsData()
    {
        ...
        $key .= Mage::helper('chestnut_layerednav')->getCacheKey($this->_requestVar);
        ...
        if ($data === null) {
            ...
            $currentIds = Mage::helper('chestnut_layerednav')->getParam($attribute->getAttributeCode());
            $tags = array(
