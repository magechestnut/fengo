...
class Chestnut_Blog_Model_Mysql4_Post extends Mage_Core_Model_Mysql4_Abstract 
{
    ...
    {        
        $select = $this->_getReadAdapter()
                ...
                ->joinLeft(array('category_main' => $this->getTable('blog/category')), 'post_category.cat_id = category_main.cat_id', array('title', 'identifier', 'posts' => new Zend_Db_Expr('GROUP_CONCAT(DISTINCT post_id)')))
