...
class Chestnut_Blog_Block_Adminhtml_Post_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml() {
        ...
        $this->addTab('options_section', array(
            ...
            'content' => $this->getLayout()->createBlock('blog/adminhtml_post_edit_tab_options')->toHtml(),
        ));
