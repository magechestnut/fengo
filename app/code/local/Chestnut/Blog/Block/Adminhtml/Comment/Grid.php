...
class Chestnut_Blog_Block_Adminhtml_Comment_Grid extends Mage_Adminhtml_Block_Widget_Grid 
{
    ...
    protected function _prepareCollection() 
    {
        ...
        $collection->getSelect()->joinLeft(array('chestnut_blog_main' => $collection->getTable('blog/blog')), 'main_table.post_id=chestnut_blog_main.post_id', array('chestnut_blog_main.title'));
    ...
    protected function _prepareColumns() 
    {
        ...
        $this->addColumn('summary', array(
            'header' => Mage::helper('blog')->__('Summary'),
            'align' => 'left',
            'index' => 'summary',
            'filter_index' => 'main_table.summary'
        ));
        ...
        $this->addColumn('chestnut_blog_main.post_id', array(
