...
class Chestnut_Blog_Adminhtml_CommentController extends Mage_Adminhtml_Controller_Action 
{
        ...
        if (!is_array($blogIds)) {
            ...
            try {
                ...
                $this->_getSession()->addSuccess(
                        $this->__('Total of %d record(s) were successfully approved', count($blogIds))
                );
            } catch (Exception $e) {
    ...
    public function massUnapproveAction() 
    {
        ...
        if (!is_array($blogIds)) {
            ...
            try {
                ...
                $this->_getSession()->addSuccess(
                        $this->__('Total of %d record(s) were successfully unapproved', count($blogIds))
                );
            } catch (Exception $e) {
                $this->_getSession()->addError($e->getMessage());
            }
