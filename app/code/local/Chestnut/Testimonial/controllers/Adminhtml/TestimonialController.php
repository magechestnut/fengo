...
class Chestnut_Testimonial_Adminhtml_TestimonialController extends Mage_Adminhtml_Controller_action 
{
	...
	public function saveAction() 
	{
		...
		if ($data = $this->getRequest()->getPost()) {
			if(isset($_FILES['avatar']['name']) && $_FILES['avatar']['name'] != '') {
                try
                {
                    $path = Mage::getBaseDir().DS.'media/chestnut/testimonial/avatar'.DS;
